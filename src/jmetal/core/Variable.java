...
public abstract class Variable implements Serializable {
    ...
    public double getValue() throws JMException {
        ...
        Configuration.logger_.error("Class " + name + " does not implement " + "method getValue");
    ...
    public void setValue(double value) throws JMException {
        Class cls = java.lang.String.class;
        String name = cls.getName();
        Configuration.logger_.error("Class " + name + " does not implement " + "method setValue");
    ...
    public double getLowerBound() throws JMException {
        Class cls = java.lang.String.class;
        String name = cls.getName();
        Configuration.logger_.error("Class " + name + " does not implement method getLowerBound()");
    ...
    public double getUpperBound() throws JMException {
        Class cls = java.lang.String.class;
        String name = cls.getName();
        Configuration.logger_.error("Class " + name + " does not implement method getUpperBound()");
    ...
    public void setLowerBound(double lowerBound) throws JMException {
        Class cls = java.lang.String.class;
        String name = cls.getName();
        Configuration.logger_.error("Class " + name + " does not implement method setLowerBound()");
    ...
    public void setUpperBound(double upperBound) throws JMException {
        Class cls = java.lang.String.class;
        String name = cls.getName();
        Configuration.logger_.error("Class " + name + " does not implement method setUpperBound()");
