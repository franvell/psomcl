...
public class XInt {
    ...
    public int getValue(int index) throws JMException {
        if (type_.getClass() == IntSolutionType.class) {
            ...
            Configuration.logger_.error("jmetal.util.wrapper.XInt.getValue, solution type " + type_ + "+ invalid");
        }
        return 0;
    }
    ...
    public void setValue(int index, int value) throws JMException {
        if (type_.getClass() == IntSolutionType.class) {
            ...
            Configuration.logger_.error("jmetal.util.wrapper.XInt.setValue, solution type " + type_ + "+ invalid");
        }
    }
    ...
    public int getLowerBound(int index) throws JMException {
        if (type_.getClass() == IntSolutionType.class) {
            ...
            Configuration.logger_.error("jmetal.util.wrapper.XInt.getLowerBound, solution type " + type_ + "+ invalid");
        }
        return 0;
    }
    ...
    public int getUpperBound(int index) throws JMException {
        if (type_.getClass() == IntSolutionType.class) {
            ...
            Configuration.logger_.error("jmetal.util.wrapper.XInt.getUpperBound, solution type " + type_ + "+ invalid");
        }
        return 0;
    }
    ...
    public int getNumberOfDecisionVariables() {
        if (type_.getClass() == IntSolutionType.class) {
            ...
            Configuration.logger_.error("jmetal.util.wrapper.XInt.size, solution type " + type_ + "+ invalid");
        }
        return 0;
    }
}
