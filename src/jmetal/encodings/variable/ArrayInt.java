...
public class ArrayInt extends Variable {
    ...
    public int getValue(int index) throws JMException {
        if ((index >= 0) && (index < size_)) {
            ...
            Configuration.logger_.error(jmetal.encodings.variable.ArrayInt.class + ".getValue(): index value (" + index + ") invalid");
    ...
    public void setValue(int index, int value) throws JMException {
        if ((index >= 0) && (index < size_)) {
            ...
            Configuration.logger_.error(jmetal.encodings.variable.ArrayInt.class + ".setValue(): index value (" + index + ") invalid");
            throw new JMException(jmetal.encodings.variable.ArrayInt.class + ": index value (" + index + ") invalid");
        } // else
    } // setValue
    ...
    public double getLowerBound(int index) throws JMException {
        if ((index >= 0) && (index < size_)) {
            ...
            Configuration.logger_.error(jmetal.encodings.variable.ArrayInt.class + ".getLowerBound(): index value (" + index + ") invalid");
    ...
    public double getUpperBound(int index) throws JMException {
        if ((index >= 0) && (index < size_)) {
            ...
            Configuration.logger_.error(jmetal.encodings.variable.ArrayInt.class + ".getUpperBound(): index value (" + index + ") invalid");
