...
public class ArrayReal extends Variable {
    ...
    public double getValue(int index) throws JMException {
        if ((index >= 0) && (index < size_)) {
            ...
            Configuration.logger_.error(jmetal.encodings.variable.ArrayReal.class + ".getValue(): index value (" + index + ") invalid");
    ...
    public void setValue(int index, double value) throws JMException {
        if ((index >= 0) && (index < size_)) {
            ...
            Configuration.logger_.error(jmetal.encodings.variable.ArrayReal.class + ".setValue(): index value (" + index + ") invalid");
    ...
    public double getLowerBound(int index) throws JMException {
        if ((index >= 0) && (index < size_)) {
            ...
            Configuration.logger_.error(jmetal.encodings.variable.ArrayReal.class + ".getLowerBound(): index value (" + index + ") invalid");
    ...
    public double getUpperBound(int index) throws JMException {
        if ((index >= 0) && (index < size_)) {
            ...
            Configuration.logger_.error(jmetal.encodings.variable.ArrayReal.class + ".getUpperBound(): index value (" + index + ") invalid");
